...
Para completar o modelo mental básico, convén introducir outros compoñentes que participan no ciclo de vida dun DAG:
...
Ter esta película xeral na cabeza axuda moito cando máis adiante vexamos o despregamento real do proxecto.
...
Segundo a arquitectura escollida, Airflow pode traballar con distintos executores. A idea xeral é que todos serven para lanzar tarefas, pero non todos o fan do mesmo xeito nin están pensados para o mesmo tamaño de despregamento.
...
Nos nosos apuntamentos e neste proxecto, 
imos traballar con `LocalExecutor`.

É unha elección moi razoable para un entorno local e docente porque:

- evita engadir infraestrutura extra innecesaria
- permite ter execución concorrente sen complicar demasiado o despregamento
- encaixa ben cun stack dockerizado pequeno e controlado

Máis adiante, cando vexamos a integración de Airflow no proxecto, volveremos sobre esta decisión técnica.
...
Unha vez asentados estes conceptos, o seguinte paso natural é ver como se desprega Airflow neste proxecto concreto e que servizos participan no seu funcionamento.
