...
![Logo de airflow](images/1.airflow-logo.png)
...
<img src="images/1.airflow-pipeline-como-dag.png" alt="Exemplo dun pipeline representado como DAG" width="750">
...
Airflow resolve un problema moi habitual en contornas de datos: non abonda con ter ferramentas capaces de procesar información, tamén fai falta coordinalas. Nunha arquitectura moderna adoitan convivir varias pezas especializadas, e cada unha cumpre un papel distinto. Por exemplo, xunto coas ferramentas que vimos durante o curso:
...
<img src="images/1.airflow-script-vs-dag.png" alt="Comparación entre script secuencial e DAG" width="750">
...
O libro tamén axuda a ver Airflow como un sistema composto por varias pezas. Nun despregamento xeral de Airflow, ademais do `scheduler` e do `executor`, hai outros compoñentes que iremos atopando con frecuencia:
...
![Arquitectura básica de Airflow](images/1.airflow-arquitectura-basica.png)

*Esquema simple da arquitectura de Airflow con usuario, ficheiro DAG, DAG processor, scheduler, executor ou workers, metastore e interface web/API. Adaptado da imaxe 1.8 do libro.*
