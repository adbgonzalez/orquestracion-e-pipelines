...
Descrición: pantalla de `Upload files to a volume`, mostrando a selección de catálogo, esquema, volume e ficheiro local.  
Fonte: elaboración propia.
...
Descrición: o esquema `lab_almacenamento` xa creado dentro do catálogo `workspace`.  
Fonte: elaboración propia.
...
Descrición: o volume `volume_entrada` visible dentro do esquema `lab_almacenamento`.  
Fonte: elaboración propia.
...
Descrición: vista do volume coa presenza do ficheiro `persoas.csv` xa cargado.  
Fonte: elaboración propia.
...
Descrición: vista da táboa `persoas_delta` en Catalog Explorer ou resultado da consulta `SELECT *`.  
Fonte: elaboración propia.
