...
- Widget de texto para recibir parámetros, cela de definición de variables e cela de importación de librarías e definición de esquemas:
...
- Cela de texto en Markdown e cela en SQL para amosar os resultados:
...
Este uso combinado de Python e SQL no mesmo notebook é especialmente práctico en tarefas de análise e enxeñaría de datos.
...
Esta idea retomarase con máis detalle no capítulo 5, dedicado á orquestración de pipelines en Databricks mediante Workflows.
...
Convén recordar algúns patróns moi habituais dentro de notebooks de Databricks:
