...
<img src="images/databricks-ui.png" alt="interface-databricks" width="750">
Figura 2.1. Interface principal de Databricks.  
Descrición: vista xeral da interface coa barra lateral, a zona de traballo e os principais puntos de acceso ás funcionalidades da plataforma.  
...
Este tipo de traballo interactivo en notebook será o punto de partida para as prácticas posteriores de almacenamento, lectura de ficheiros e creación de táboas en Databricks.
